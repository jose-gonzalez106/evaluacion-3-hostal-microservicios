...
public class ReservaService {
        ...
        public Reserva crear(String huespedRun, Integer habitacionNumero, Reserva reserva) {
                log.info("[ReservaService] Creando reserva para huesped {} en habitacion {}", huespedRun,
                                habitacionNumero);
                ...
                Habitacion habitacion = habitacionRepository.findByNumero(habitacionNumero)
                                .orElseThrow(() -> {
                                        ...
                                        return new RecursoNoEncontradoException(
                                                        "la habitacion " + habitacionNumero + " no existe");
                                });

                if (!habitacion.getEstado().equalsIgnoreCase("libre")) {
                        log.warn("[ReservaService] Habitacion {} no disponible, estado: {}", habitacionNumero,
                ...
                if (!reserva.getFechaTermino().isAfter(reserva.getFechaInicio())) {
                        log.warn("[ReservaService] Fechas invalidas: inicio={} termino={}", reserva.getFechaInicio(),
                ...
                reserva.setHuespedRun(huesped.getRun());
                ...
                log.info("[ReservaService] Reserva creada con id: {}, precio: {}", guardada.getId(),
                                guardada.getPrecio());
                return guardada;
        }
        ...
        public String cancelar(Long id) {
                ...
                log.info("[ReservaService] Reserva {} cancelada, habitacion {} disponible nuevamente", id,
        ...
        private ReservaDTO convertirADTO(Reserva reserva) {
                ...
                dto.setHuesped(reserva.getHuespedRun());
